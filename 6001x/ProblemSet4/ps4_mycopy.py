...
def playGame(wordList):
    ...
    n = HAND_SIZE
    while True:
        invitation = input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
        if invitation == 'n':
            hand = dealHand(n)
...
'''hand = {'a': 2, 'e': 1, 'm': 2, 's': 2, 't': 1}'''
'''wordList = ['cow', 'elephant', 'goat', 'wolf', 'snake', 'snail', 'mouse',
            'tiger', 'cat', 'dog', 'horse', 'mes', 'tam']
'''
'''n = 9
wordList = loadWords()
playHand(hand, wordList, n)'''
