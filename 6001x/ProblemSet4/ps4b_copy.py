...
def playGame(wordList):
    ...
    2) Asks the user to input a 'u' or a 'c'.
        * If the user inputs anything that's not 'c' or 'u', keep asking 
        them again.
    ...
    n = HAND_SIZE
    while True:
        invite = input('Enter n to deal a new hand, \
r to replay the last hand, or e to end game: ')
        if invite == 'e':
            break
        elif invite not in 'nr':
...
Please play a new hand first!')
                ...
                while True:
                    who_plays = input('Enter u to have yourself play, \
