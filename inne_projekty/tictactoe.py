# -*- coding: utf-8 -*-
"""
Created on Mon Aug 14 21:59:37 2017
...
def inputPlayerLetter():
    '''Lets the player type which letter they want to be. Returns a list
    with the player's letter as the first item, and the computers's letter
    as the second.'''
    letter = ''
...
def getComputerMove(board, computerLetter):
    ...
    # Here is an algorithm for my TicTacToe AI:
