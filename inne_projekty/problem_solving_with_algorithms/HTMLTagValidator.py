...
'''
A program that can check an HTML document for proper opening and closing tags - thanks to mbhushan and his algorithm accessible on GitHub.
'''
...
def readinput():
    print ("Enter html string: ") # examples in HTMLTagValidator_inout.txt 
    htmlStr = input()
    return htmlStr
