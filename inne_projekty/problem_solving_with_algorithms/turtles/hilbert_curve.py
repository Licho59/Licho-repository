"""
Using the turtle graphics module, write a recursive program to display a Hilbert curve. Algorithm thanks to Molly Zhang by GitHub.
"""
import turtle
import operator
...
COLORS = ["orange", "green", "purple", "blue", "red", "black"] * 
...
def make_16_points_outof_4(four_points):
    ...
    for corner in range(1, 5):
        sixteen_points = sixteen_points + \
            make_corner_points(four_points, corner)
...
def make_corner_points(four_points, corner):
    ...
    for point in four_points:
        smaller_four_points.append(
            (i / 2.0 for i in tuple(map(operator.add, point, center))))
    shifted_points = []
